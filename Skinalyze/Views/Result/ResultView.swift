...
//                HStack{
//                    Text("Ingredients You Should Avoid")
//                        .font(
//                            Font.custom("Quattrocento Sans", size: 20)
//                                .weight(.bold)
//                        )
...
//                    .background(Color(red: 0.29, green: 0.14, blue: 0.24).opacity(0.1))
//                    .cornerRadius(100)
//                }
//                ForEach(acneCounts.keys.sorted(), id: \.self){acne in
//                    VStack(alignment: .leading, spacing: 4){
//                        Text(acne.capitalized)
//                            .font(Font.custom("Quattrocento Sans", size: 15))
//                            .foregroundColor(Color("PrimaryFontColor"))
//                        Text("Count: \(acneCounts[acne] ?? 0)")
//                            .font(Font.custom("Quattrocento Sans", size: 12))
...
//            .background(Color(red: 0.59, green: 0, blue: 0).opacity(0.1))
//            .cornerRadius(10)
//            
//            
//            Button("Refresh") {
...
//#Preview {
//    ResultView(path: .constant(["imgTest"]), images: [UIImage(named: "imgTest")!])
//}
